...
const translations = {
  zh: {
    ...
    viewDetail: '查看详情',
    deleteRoute: '删除',
    flightQuery: '查询实时机票价格',
    searchAddCity: '输入城市名称搜索...',
    transportMode: '交通方式：',
    editTip: '提示：搜索添加城市，或开启"地图点击添加"后在地图上点击添加',
    addCityToEdit: '添加城市到编辑线路',
    positionLabel: '位置:',
    inputCityName: '请输入城市名称',
    moveUp: '上移',
    moveDown: '下移',
    ...
    departCity: '出发',
    clickToViewDetail: '查看城市详情',
    confirmRemoveCity: '确定移除这个城市吗？',
    searchFailed: '搜索失败',
    saveFailed: '保存失败',
    deleteCitySuccess: '已删除城市',
    routeAddedToMap: '已添加到地图',
    mapClickModeOn: '已开启地图点击添加模式，请点击地图选择位置',
    mapClickModeOff: '已退出地图点击添加模式',
    routeSaveSuccess: '路线保存成功',
    gpxExportFailed: 'GPX 导出失败',
    gpxImportFailed: '导入 GPX 失败',
    noGpxRoutes: 'GPX 文件中没有找到有效路线',
    importSuccess: '成功导入',
    routesCount: '条路线',
    mapExportSuccess: '地图导出成功',
    mapExportFailed: '导出地图失败，请重试',
    noExportRoutes: '没有可导出的轨迹',
    citiesLabel: '个城市',
    routeName: '路线名称',
    addCityToRoute: '添加城市',
    clickMapToAdd: '点击地图添加城市位置',
    selectedTransport: '选择交通方式',
    fromPreviousCity: '选择从前一个城市到达此城市的交通方式',
    drivingDesc: '驾车 - 沿道路行驶',
    trainDesc: '火车 - 铁路路线',
    flightDesc: '飞机 - 直线飞行',
    walkingDesc: '步行 - 步行路线',
  },
  ...
  en: {
    ...
    viewDetail: 'View Detail',
    deleteRoute: 'Delete',
    flightQuery: 'Query Flight Prices',
    searchAddCity: 'Search city name...',
    transportMode: 'Transport:',
    editTip: 'Tip: Search to add city, or enable "Map Click" to add on map',
    addCityToEdit: 'Add City to Edit Route',
    ...
    fromCity: 'from',
    departCity: 'depart',
    confirmRemoveCity: 'Remove this city?',
    searchFailed: 'Search failed',
    saveFailed: 'Save failed',
    deleteCitySuccess: 'City deleted',
    routeAddedToMap: 'Added to map',
    mapClickModeOn: 'Map click mode enabled, click map to add city',
    mapClickModeOff: 'Map click mode exited',
    routeSaveSuccess: 'Route saved successfully',
    gpxExportFailed: 'GPX export failed',
    gpxImportFailed: 'GPX import failed',
    noGpxRoutes: 'No valid routes found in GPX file',
    importSuccess: 'Successfully imported',
    routesCount: 'routes',
    citiesLabel: 'cities',
    routeName: 'Route Name',
    addCityToRoute: 'Add City',
    clickMapToAdd: 'Click map to add city position',
    selectedTransport: 'Select Transport',
    fromPreviousCity: 'Select transport mode from previous city',
    drivingDesc: '🚗 Driving - Follow roads',
    trainDesc: '🚂 Train - Railway route',
    flightDesc: '✈️ Flight - Direct flight',
    walkingDesc: '🚶 Walking - Walking route',
  }
};
